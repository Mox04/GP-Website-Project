var AfricaPrograms = {
	"bw": {
		...
		"progdesc": ["Orphan Care Program:<br>The Batswana program aims to aid the orphan child population. The program supports children institutionally and materially (monthly food basket between $60 and $80).", "placeholder"],
...
var EuropePrograms = {
	"pl": {
		...
		"progdesc": ["Family 500+:<br>The program is a monthly, tax-free payment worth $130 The family receives for every child below the age of 18, regardless of income and other factors. Payments range from $0 to $6,500 annually", "placeholder"],
...
var AsiaPrograms = {
	"bd" : {
		...
		"progdesc": ["...:<br>...", "placeholder"], //INFO MISSING//
...
var NAPrograms = {
	"ca": {
		...
		"progdesc": ["Canadian Child Benefit:<br>The program is a monthly, tax-free payment to help with the costs of raising children. The values of the payment depend on factors such as child age and household income.", "placeholder"],
...
var SAPrograms = {
	"br": {
		...
		"progdesc": ["Bolsa Família:<br>...", "placeholder"], //INFO MISSING//
